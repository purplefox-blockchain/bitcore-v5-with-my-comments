...
var InsightUI = function(options) {
  ...
  //if the ~/.bitcore/bitcore-node.json configures these two properties, the default setting 'api' for apiPrefix
  //and '' for routePrefix will not take effect. since we want to make these very explicit, we should always
  //define both xxxPrefix in bitcore-node.json NOT in this js
