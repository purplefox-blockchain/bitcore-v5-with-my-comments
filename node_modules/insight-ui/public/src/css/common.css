...
#ngProgress {
  background-color: #6C9032 !important;   /* YCM Green */
...
.table-hover>tbody>tr:hover>td, .table-hover>tbody>tr:hover>th {
  background-color: #F0F7E2;      /* YCM Green */
}
...
.navbar-default {
  background-color: #373D42; /* #8DC429; */ /* by YCM antpool */
  margin: 0;
  border: 0;
}

.navbar-default .navbar-nav>li>a {
  color: #fff; /* #F4FBE8; */  /* by YCM antpool */
  font-family: 'Ubuntu', sans-serif;
  padding-left: 20px;
  padding-right: 20px;
}
...
.navbar-default .navbar-nav>.active>a, .navbar-default .navbar-nav>.active>a:focus {
  background-color: #fff; /* #6C9032; */ /* by YCM antpool */
  color: #fff;
}
...
.navbar-form .form-control {
  background-color: #ccc; /* #7CAD23; */ /* by YCM antpool */
  border-radius: 3px;
...
#search::-webkit-input-placeholder {
  color: #fff; /* #BCDF7E; */ /* by YCM antpool */
  font-family: 'Ubuntu', sans-serif;
  font-style: italic;
  font-weight: 100;
}
...
.status {
  -moz-border-radius: 3px;
  -webkit-border-radius: 3px;
  background-color: #373D42; /* #597338; */ /* by YCM antpool */
  border-radius: 3px;
  margin: 15px 0;
  padding: 8px 10px;
  font-size: 12px;
