...
//wow, an very important implementation code package
//p2p/index.js has the following codes
//messages.GetData messages.GetBlocks messages.GetHeaders messages.MemPool message.Inventory messages.Transaction
//all these cant be found if you search this js file
//they are dynamically registered in the Message(options) constructor
//more specifically, messages.GetBlocks
// => messages.builder.commands[GetBlocks]
/**
...
function Messages(options) {
  ...
  for(var key in this.builder.commandsMap) {
    ...
    //register a lot of supported commands here!!!
    //when other modules (e.g. p2p) use 'messages.GetBlocks', it means messages.builder.commands[GetBlocks]
    //look for buider.js for how the message is constructed (around line 67+)
